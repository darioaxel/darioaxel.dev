---
navigation:
    title: 'Saltos en redes de computadoras'
    description: 'En el proceso de transmisión de datos entre computadoras se producen diversos cambios o saltos entre las redes que un paquete se cuentra. En este artículo estudiaremos qué es un salto y que otros conceptos se le asocian.'
    writtenAt: '01/10/2022'
    tags: ['redes']
---

[1. Saltos o Hop](#1-saltos-o-hop)  
    [1.1. Definición de salto](#11-definición-de-salto)  
    [1.2. Hop Limit](#12-límite-de-saltos-o-hop-limit)  
    [1.3. Next Hop](#13-siguiente-salto-o-next-hop)  
[2. Ejercicios](#2-ejercicios)  
[3. Bibliografía](#3-bibliografía)  

# 1. Saltos o Hop 
## 1.1. Definición de *salto*
En el campo de las telecomunicaciones se define como *salto* (del inglés *hop*) una porción del camino de una señal que discurre entre la fuente emisora y el receptor final. Por ejemplo, en el envío de una onda de radio desde la tierra a la ionosfera y su vuelta a tierra, el número de saltos indica la cantidad de reflexiones desde la ionosfera. 
