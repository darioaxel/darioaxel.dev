...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  }><div class="w-full flex flex-col items-center md:w-11/12 md:flex-row md:justify-between"><div class="mb-2 lg:mb-0"><div>Made with Nuxt. Copyright ${
