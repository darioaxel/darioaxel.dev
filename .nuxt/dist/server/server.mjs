...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  } data-v-302ba800><div class="flex align-baseline" data-v-302ba800><div class="first-name text-4xl text-themePrimary" data-v-302ba800>darío</div><div class="second-name text-4xl text-themeText" data-v-302ba800>axel</div></div><div class="pl-2" data-v-302ba800><svg width="40px" height="40px" viewBox="0 0 69.697037 55.915504" version="1.1" id="svg2082" xmlns="http://www.w3.org/2000/svg" xmlns:svg="http://www.w3.org/2000/svg" data-v-302ba800><defs id="defs2079" data-v-302ba800></defs><g id="layer1" transform="translate(-2.3168178,-9.4458628)" data-v-302ba800><path id="path792" style="${
