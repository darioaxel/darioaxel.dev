  ...
  <footer class=" w-full flex justify-center bg-themeBackground text-themeText pb-2 md:pt-2">
    <div class=" w-full flex flex-col items-center md:w-11/12 md:flex-row md:justify-between">
      ...
      <ul class="flex items-center space-x-8">
        <li>
          <a href="mailto:me@example.com" class="text-themeText hover:text-gray-400">
        ...
        <li>
          <a href="https://github.com/darioaxel" target="_blank" class="text-themeText hover:text-gray-400">
        ...
        <li>
          <a href="https://twitter.com/darioaxel" target="_blank" class="text-themeText hover:text-gray-400">
